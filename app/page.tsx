    ...
    <main>
      <section className="hero" id="top">
        <nav className="nav" aria-label="Навигация">
          <a className="brand header-brand" href="#top" aria-label="Kids Blogging School — Мягкий старт, в начало">
            <Image className="brand-logo" src="/brand/kbs-logo.svg" alt="Kids Blogging School" width={545} height={162} priority unoptimized />
      ...
      <footer>
        <div className="section-shell footer-grid">
          <div><div className="footer-brand"><Image className="brand-logo" src="/brand/kbs-logo.svg" alt="Kids Blogging School" width={545} height={162} unoptimized /></div><p>«Мягкий старт» — практический материал для родителей.</p></div>
